...
<body>
    <!-- banner-inner -->
    <div id="demo-1" data-zs-src='["images/1.jpeg", "images/002.jpg","images/003.jpg", "images/004.jpg"]' data-zs-overlay="dots">
 ...
 <a href="single-job-details.php?viewid=<?php echo $row['ID'];?>" class="aply-btn "> Details</span></a>
                                   ...
                                   <a href="jobs-listed.php" class="aply-btn ">More..</a>
                                    ...
                                    <div class="col-lg-4 text-info-sec">
                                        <img src="images/job001.jpg" alt=" " class="img-fluid" />
                                    </div>
